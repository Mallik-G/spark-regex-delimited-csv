 ...
 */
package org.anish.spark.regexcsv.util
...
private[regexcsv] object InferSchema {
  ...
  private[regexcsv] def mergeRowTypes(
   ...
   */
  private[regexcsv] def inferField(typeSoFar: DataType,
      field: String,
      nullValue: String = "",
